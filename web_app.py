...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Blindaje: si por cualquier motivo el textarea no esta presente, NO cortar
    // el resto del DOMContentLoaded (sino queda sin cablear el boton "Resaltar y
    // definir" y otros handlers de mas abajo). Antes esto lanzaba un TypeError
    // que abortaba todo el listener.
    if (textarea) {
